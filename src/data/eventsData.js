const eventsData = [
  ...
  },
  {
    ...
    description: "Experience live performances from top artists across multiple genres.",
    image: "https://pbs.twimg.com/media/Gsd7KmoXwAA2NPN?format=png&name=small",
    eventType: "Festival/Fair",
    price: 350
  },
  {
    id: 6,
    ...
    description: "Taste dishes from around the globe prepared by world-class chefs.",
    image: "https://pbs.twimg.com/media/Gsm6GQKasAEqMs5?format=jpg&name=small",
    eventType: "Pop-up Event/Experience",
    price: 120
  },
  {
    id: 7,
    ...
    description: "Discover the latest in sustainable technology and eco-friendly living.",
    image: "https://pbs.twimg.com/media/GsjmQQUasAY1NpK?format=jpg&name=small",
    eventType: "Conference",
    price: 75
  },
  {
    ...
    description: "A gathering for filmmakers to share, learn, and collaborate.",
    image: "https://pbs.twimg.com/media/GshHNhhb0AEIlXa?format=jpg&name=900x900",
    eventType: "Networking Event/Meetup",
    price: 100
  }
];
